...
//        path+="?search_history_type="+ URLEncoder.encode("novel_search_history","utf-8");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_animation, null);

//        for(int i=0;i<9;++i)
//        stringList.add("上音");

        recyclerviewNewsRecommend = (RecyclerView)inflate.findViewById(R.id.recyclerNewsAnimation);
...
//        修改R.layout后面的元素，内容为，recyelerview的子布局的layout
        public NewsRecommendRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view=mInflater.inflate(R.layout.news_recommend_elem_layout,parent,false);
            NewsRecommendRecyclerAdapter.ViewHolder viewHolder=new NewsRecommendRecyclerAdapter.ViewHolder(view);
            return viewHolder;
        }
        /**
         * 数据的绑定显示
...
//        设置内容，和监听器。
        @Override
        public void onBindViewHolder(NewsRecommendRecyclerAdapter.ViewHolder holder, int position) {
//            作者名字
