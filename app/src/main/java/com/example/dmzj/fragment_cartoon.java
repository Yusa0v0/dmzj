...
//        path+="?search_history_type="+ URLEncoder.encode("novel_search_history","utf-8");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View inflate = inflater.inflate(R.layout.fragment_cartoon, null);

//        for(int i=0;i<9;++i)
//        stringList.add("上音");

        recyclerviewNewsRecommend = (RecyclerView)inflate.findViewById(R.id.recyclerNewsCartoon);
