...
import static com.example.dmzj.R.id.recyclerNewsRecommend;
...
//        stringList.add("上音");
        ...
        recyclerviewNewsRecommend = (RecyclerView)inflate.findViewById(recyclerNewsRecommend);
...
//      Banner
        ...
        list_path.add("http://192.168.137.1:8080/banner_cover/8.png");
        list_path.add("http://192.168.137.1:8080/banner_cover/5.png");
        list_path.add("http://192.168.137.1:8080/banner_cover/6.png");
        list_path.add("http://192.168.137.1:8080/banner_cover/9.png");
        list_title.add("剧场版动画《名侦探柯南 万圣节的新娘》新预告");
        list_title.add("TV动画《86-不存在的战区-》22与23话延期播出");
        list_title.add("SE手游《Gate of Nightmares》漫画版开始连载");
        list_title.add("周五榕树下·三连回顾第九期");
